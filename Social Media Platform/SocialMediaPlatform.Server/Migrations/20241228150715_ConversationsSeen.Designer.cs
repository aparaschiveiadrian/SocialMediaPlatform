...
namespace SocialMediaPlatform.Server.Migrations
{
    ...
    [Migration("20241228150715_ConversationsSeen")]
    partial class ConversationsSeen
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "55a1992e-6ddd-4d9a-af71-fc909e3b6531",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "de7890f8-0b11-4a53-89d9-8e9487a76320",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("SocialMediaPlatform.Server.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<string>("UserConversationUserId")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("SocialMediaPlatform.Server.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasOne("SocialMediaPlatform.Server.Models.UserConversation", null)
                        .WithMany("SeenUserList")
