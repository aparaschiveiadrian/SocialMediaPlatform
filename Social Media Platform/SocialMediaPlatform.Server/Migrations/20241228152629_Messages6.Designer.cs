...
namespace SocialMediaPlatform.Server.Migrations
{
    ...
    [Migration("20241228152629_Messages6")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplicationUserConversation", b =>
                {
                    ...
                    b.Property<string>("PendingUsersId")
                        .HasColumnType("text");

                    b.HasKey("ConversationId", "PendingUsersId");
            ...
            modelBuilder.Entity("ApplicationUserConversation1", b =>
                {
                    b.Property<int>("Conversation1Id")
                        .HasColumnType("integer");

                    b.Property<string>("SeenUserListId")
                        .HasColumnType("text");

                    b.HasKey("Conversation1Id", "SeenUserListId");

                    b.HasIndex("SeenUserListId");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "7d5238c8-3bdf-486b-806f-7abd0c7470fe",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "e45b1e10-0bf2-40ca-b47c-324ef8611bcc",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("ApplicationUserConversation1", b =>
                {
                    b.HasOne("SocialMediaPlatform.Server.Models.Conversation", null)
                        .WithMany()
                        .HasForeignKey("Conversation1Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SocialMediaPlatform.Server.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("SeenUserListId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
